...
CREATE OR REPLACE STAGE redfin_database_1.external_stage_schema.redfin_ext_stage_ym 
    url="s3://redfin-transform-zone-ym/"
    credentials=(aws_key_id='[Private]'
    aws_secret_key='[Private]')
    FILE_FORMAT = redfin_database_1.file_format_schema.format_csv;

list @redfin_database_1.external_stage_schema.redfin_ext_stage_ym;
...
FROM @redfin_database_1.external_stage_schema.redfin_ext_stage_ym;
